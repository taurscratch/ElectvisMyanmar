...
class CreateRepresentativeHousesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('representative_houses', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('representative_houses');
    }
}
